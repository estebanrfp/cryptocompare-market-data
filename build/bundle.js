...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      var displayQuote = function displayQuote(_quote) {
        var fsym = window.CCC.STATIC.CURRENCY.SYMBOL[_quote.FROMSYMBOL];
        var tsym = window.CCC.STATIC.CURRENCY.SYMBOL[_quote.TOSYMBOL];
        var pair = _quote.FROMSYMBOL + _quote.TOSYMBOL;

        var node = document.getElementById('price_' + pair);
        if (_quote.FLAGS === '1') {
          // node.className = 'up'
          // node.innerHTML = 'Up'
        ...
        function renderme(id, value) {
          (0, _preact.render)('' + value, document.getElementById(id), document.getElementById(id).lastChild);
        }
      ...
      var updateQuote = function updateQuote(result) {
      ...
      this.socket = __webpack_require__(42)('https://streamer.cryptocompare.com/');

      // Format: {SubscriptionId}~{ExchangeName}~{FromSymbol}~{ToSymbol}
      // Use SubscriptionId 0 for TRADE, 2 for CURRENT and 5 for CURRENTAGG
      // For aggregate quote updates use CCCAGG as market

      var subscription = ['5~CCCAGG~BTC~USD', '5~CCCAGG~ETH~USD', '5~CCCAGG~ETC~USD', '5~CCCAGG~LTC~USD', '5~CCCAGG~DASH~USD'];

      setTimeout(function () {
        _this2.socket.emit('SubAdd', { subs: subscription });
      }, 150);
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    'table',
                    { summary: 'test', style: this.tablestyle, 'class': 'table table-bordered table-hover' },
                    (0, _preact.h)(
                      'thead',
                      null,
                      (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'tbody',
                      null,
                      Object.values(state.list).map(function (item) {
                        return (0, _preact.h)(
                          'tr',
                          null,
                          (0, _preact.h)(
                            ...
                            (0, _preact.h)(
                              'td',
                              null,
                              (0, _preact.h)('img', { role: 'presentation', width: '25', alt: 'presentation', src: item.Image })
                            ),
                            (0, _preact.h)(
                              'td',
                              null,
                          ...
                          (0, _preact.h)(
                            'td',
                            { id: 'price_' + item.Name + 'USD' },
                            '...'
                          ),
                          (0, _preact.h)(
                            'td',
                            { id: 'market_' + item.Name + 'USD' },
                            '...'
                          ),
                          (0, _preact.h)(
                            'td',
                            ...
                            (0, _preact.h)(
                              'p',
                              { id: '24volume_' + item.Name + 'USD' },
                              '...'
                            ),
                            (0, _preact.h)(
                              'p',
                              { id: '24volumeto_' + item.Name + 'USD' },
                              '...'
                            )
                          ),
                          (0, _preact.h)(
                          ...
                          (0, _preact.h)(
                            ...
                            (0, _preact.h)(
                              'p',
                              { id: 'volume_' + item.Name + 'USD' },
                              '...'
                            ),
                            (0, _preact.h)(
                              'p',
                              { id: 'volumeto_' + item.Name + 'USD' },
                              '...'
                            )
                          ),
                          (0, _preact.h)(
                            ...
                            (0, _preact.h)(
                              'p',
                              { id: 'change_' + item.Name + 'USD' },
                              '...'
                            ),
                            (0, _preact.h)(
                              'p',
                              { id: 'changepct_' + item.Name + 'USD' },
                              '...'
                            )
                          )
                        );
